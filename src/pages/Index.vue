<template>
  <q-page class="page">
    ...
    <q-btn unelevated round :color="$q.dark.isActive ? 'grey' : 'dark'" :icon="$q.dark.isActive ? 'light_mode' : 'dark_mode'" class="absolute" size="md" style="top: 35px; left: 15px; transform: translateY(-50%); z-index: 5;" @click="$q.dark.isActive = !$q.dark.isActive" />
  </q-page>
</template>
